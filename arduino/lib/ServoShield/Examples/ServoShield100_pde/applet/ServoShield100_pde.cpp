...
void setup()
{
  ...
  {
    servos.setbounds(servo, 800, 2200);  //Set the minimum and maximum pulse duration of the servo
...
void loop()
{
  for(int pos = 800; pos < 2200; pos++)  //Move the servos from 0 degrees to 180 degrees 
  ...
  for(int pos = 2200; pos >= 800; pos--) //Move the servos from 180 degrees to 0 degrees 
  {                                
